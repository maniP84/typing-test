  ...
  return (
    ...
    <Navbar/>
      ...
      <Switch>
        ...
        <Route path="/test" render={(props) => <Test select={select} typeHandler={typeHandler} second={second} minutes={minutes} type={type} startState={startState} text={text} num={num} {...props}/>}/>
